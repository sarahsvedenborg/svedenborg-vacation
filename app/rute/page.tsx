  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        <h2 className="font-serif text-2xl">Interaktivt rutekart</h2>
        <iframe
      ...
      <section className="space-y-6">
        <h2 className="font-serif text-2xl">Dag-for-dag plan</h2>
          ...
          {itinerary.map((day) => (
            <article key={day.dayNumber} className="grid gap-4 py-8 md:grid-cols-[80px_1fr]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm leading-relaxed text-foreground/85">{day.description}</p>
              </div>
            </article>
          ))}
        </div>
